<template>
  <div class="toolBar">
    ...
    >
      ...
      <AMenu>
        <AMenuItem v-for="item in lineTypes" :key="item">
          <div class="flex middle" @click="changeLineType(item.value)">
            {{ item.name }} <span class="flex-grow" />
            <svg class="l-icon" aria-hidden="true">
    ...
    >
      ...
      <AMenu>
        <AMenuItem v-for="item in fromArrows" :key="item">
          <div
            class="flex middle"
            style="height: 30px"
    ...
    >
      ...
      <AMenu>
        <AMenuItem v-for="item in toArrows" :key="item">
          <div
            class="flex middle"
            style="height: 30px"
    ...
    <ATooltip content="100%视图" placement="bottom">
      <a @click="onScaleDefault">
        <IconFont type="ReloadOutlined" />
      </a>
    </ATooltip>
    <ATooltip content="窗口大小" placement="bottom">
      <a style="margin-left: -16px" @click="onScaleWindow">
        <!-- <t-icon name="fullscreen-exit"/> -->
        <IconFont type="FullscreenOutlined" />
      </a>
    </ATooltip>
    <div style="width: 36px" />
    <ATooltip content="运行查看">
      <!-- <t-icon name="play-circle-stroke" @click="onView" /> -->
      <IconFont type="PlayCircleOutlined" @click="onView" />
    </ATooltip>
  </div>
</template>
