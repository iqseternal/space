...
export const SYSYTEM_GRAPHIC_GROUPS: GraphicGroup = [
  {
    ...
    list: [
      {
        name: '正方形', icon: 'l-rect', id: 1,
        data: { width: 100, height: 100, name: 'square' },
      },
      {
        name: '矩形', icon: 'l-rectangle', id: 2,
        data: {
          width: 200,
          height: 50,
          borderRadius: 0.1,
      ...
      {
        name: '圆', icon: 'l-circle', id: 3,
        data: { width: 100, height: 100, name: 'circle' },
      },
      {
        name: '三角形', icon: 'l-triangle', id: 4,
        data: { width: 100, height: 100, name: 'triangle' },
      },
      {
        name: '菱形',
        icon: 'l-diamond',
